...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'happyr.google.api.groups_migration' => 'getHappyr_Google_Api_GroupsMigrationService',
            ...
            'monolog.logger.google_client' => 'getMonolog_Logger_GoogleClientService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 32770, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'password', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_00d9ea23d506fe83ddde94b0452ad73a24a4716fd879c3c8a2f14769cb1f03ed');
    ...
    {
        return $this->services['happyr.google.api.client'] = new \HappyR\Google\ApiBundle\Services\GoogleClient(array('application_name' => 'TODO-List Project', 'oauth2_client_id' => '67943194789-69vt3g4866c0je7aj5tm62edn9nmsdlq.apps.googleusercontent.com', 'oauth2_client_secret' => 'gEPR1J0G2a4F4ycTX_0vunBo', 'oauth2_redirect_uri' => 'http://127.0.0.1:8000/', 'developer_key' => '67943194789-69vt3g4866c0je7aj5tm62edn9nmsdlq.apps.googleusercontent.com', 'site_name' => 'todolist-project.fr'), $this->get('monolog.logger.google_client', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }

    /**
     * Gets the 'happyr.google.api.groups_migration' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HappyR\Google\ApiBundle\Services\GroupsMigrationService A HappyR\Google\ApiBundle\Services\GroupsMigrationService instance.
     */
    protected function getHappyr_Google_Api_GroupsMigrationService()
    {
        return $this->services['happyr.google.api.groups_migration'] = new \HappyR\Google\ApiBundle\Services\GroupsMigrationService($this->get('happyr.google.api.client'));
    }
    ...
    /**
     * Gets the 'monolog.logger.google_client' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Bridge\Monolog\Logger A Symfony\Bridge\Monolog\Logger instance.
     */
    protected function getMonolog_Logger_GoogleClientService()
    {
        $this->services['monolog.logger.google_client'] = $instance = new \Symfony\Bridge\Monolog\Logger('google_client');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $e = new \Symfony\Component\HttpFoundation\RequestMatcher('^/oauth/callback$');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57584d68e92457.67432732')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_HAS_TOKEN' => array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SfGoogleApiBundle' => 'SfGoogleApiBundle\\SfGoogleApiBundle',
            ...
            'application_name' => 'TODO-List Project',
            'oauth2_client_id' => '67943194789-69vt3g4866c0je7aj5tm62edn9nmsdlq.apps.googleusercontent.com',
            'oauth2_client_secret' => 'gEPR1J0G2a4F4ycTX_0vunBo',
            'oauth2_redirect_uri' => 'http://127.0.0.1:8000/',
            'developer_key' => '67943194789-69vt3g4866c0je7aj5tm62edn9nmsdlq.apps.googleusercontent.com',
            'site_name' => 'todolist-project.fr',
            'locale' => 'en',
